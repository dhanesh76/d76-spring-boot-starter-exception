...
public final class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiErrorResponse> handleBusinessException(BusinessException ex,
        ...
        applyCustomizers(responseBuilder, ex, request);
    ...
    ResponseEntity<ApiErrorResponse> handleException(HttpServletRequest request, Exception ex) {
    ...
    private void applyCustomizers(ApiErrorResponse.Builder builder, Exception ex, HttpServletRequest request) {
        for (var customizer : customizers) {
            customizer.customize(builder, ex, request);
        }
    }
}
